...
const Home = () => {
  ...
  if (loading) return <p className="text-center text-xl text-gray-600 mt-12">Loading...</p>;
  if (!users.length) return <p className="text-center text-xl text-gray-600 mt-12">There are no users</p>;
